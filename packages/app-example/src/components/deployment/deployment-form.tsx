  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Create a custom mobile app with your branding that will be built and deployed automatically.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Choose your brand's primary color. This will be used throughout the app.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
