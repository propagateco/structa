import type { AppPricingModel } from "@core/app/app-pricing.model";
...
function RouteComponent() {
	...
	const { data: stripeAccount, isLoading: isLoadingStripe } = useQuery(
		stripeAccountQueryOptions,
	);

	const { data: appPricing, isLoading: isLoadingAppPricing } = useQuery(
		appPricingQueryOptions(),
	);

	const { data: branding, isLoading: isLoadingBranding } =
		useQuery(brandingQueryOptions);
