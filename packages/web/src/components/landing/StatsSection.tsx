    ...
    stats = [
        {
            value: "500K+",
            label: "Lines of code",
            description: "In-house developers leveraging 100+ years of experience & the latest AI coding agents = 14-day MVP."
        },
        {
            value: "4M+",
            label: "Cold emails",
            description: "We'll build & deploy your outbound systems to get your first customers, handling infrastructure, lead sourcing & everything in-between."
        },
        {
            value: "Infinite",
            label: "Revisions",
            description: "We're not a one-and-done agency. We'll keep building your MVP & improving your systems, and there's a refund-guarantee to be super-safe."
        },
        {
            value: "100%",
            label: "Code ownership",
            description: "Obviously. You own every single line of code & the outbound system we build you from scratch."
        }
    ],
}: StatsSectionProps) {
    return (
