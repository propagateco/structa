  ...
  return (
    <div className="aui-composer-action-wrapper relative flex items-center justify-between">
      ...
      <div className="flex items-center gap-1.5">
        ...
        {/* iss-017 Q7: no stop button — show a muted send while a run is in-flight.
            `isSendDisabled` on the runtime already makes send a no-op. */}
        <AuiIf condition={(s) => s.thread.isRunning}>
          <span
            data-slot="aui_composer-send-disabled"
            aria-label="Send disabled while a run is in progress"
            className="flex size-7 cursor-default items-center justify-center rounded-full opacity-40"
          >
            <ArrowUpIcon className="aui-composer-send-icon size-4.5" />
          </span>
        </AuiIf>
  ...
  return (
    ...
    >
      ...
      <div className="aui-user-message-content-wrapper relative col-start-2 min-w-0">
        <div className="aui-user-message-content peer bg-muted text-foreground rounded-xl px-4 py-2 text-base wrap-break-word empty:hidden [&_p]:text-base">
