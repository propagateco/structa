...
const buttonVariants = cva(
	"group inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-sm font-medium hover:cursor-pointer ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0 transition-colors duration-300 ease-in-out",
	{
		variants: {
			variant: {
				...
				outline:
					"bg-background border border-input hover:bg-secondary hover:text-foreground",
				secondary:
			...
			size: {
				...
				xs: "h-6 px-2 text-xs [&_svg]:size-3 [&_svg]:shrink-0 rounded-xs",
