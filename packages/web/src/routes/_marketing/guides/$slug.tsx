                        ...
                        <div className="absolute w-full bottom-0 left-0">
                            ...
                            <TexturedDiv className="text-center bg-background py-12">
                                <div className=" px-lg mx-auto max-w-md md:max-w-xl mb-6 space-y-6">
                                    <h3 className="font-heading font-light text-3xl md:text-4xl lg:text-5xl text-center">
                                        Sign up below to continue reading for
                                        free
                                    </h3>
                                    <p className="text-sm sm:text-base text-balance text-center">
                                        The rest of this article is available
                                        with a free membership, which come with
                                        a host of benefits:
                                    </p>
                                    <ul className="flex flex-col items-center mx-auto md:mx-18 text-sm gap-5">
                                        ...
                                        <li className="flex flex-row items-center gap-2">
                                            <Sparkle className="size-4 text-ds-apricot fill-ds-apricot" />
                                            Early access to planning and design
                                            tools
                                        </li>

                                        <li className="flex flex-row items-center gap-2">
                                            <Sparkle className="size-4 text-ds-apricot fill-ds-apricot" />
                                            Improve you DIY and home improvement
                                            skills
                                        </li>
