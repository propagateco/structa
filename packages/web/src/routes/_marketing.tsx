...
function LayoutComponent() {
    return (
        <>
            <div className="z-10 text-text min-h-screen flex flex-col relative bg-background overflow-y-auto">
                {/* <div className="z-10 text-text min-h-screen flex flex-col relative bg-background"> */}
                <Header />
