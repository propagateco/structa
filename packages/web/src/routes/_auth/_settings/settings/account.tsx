...
function AccountSettings() {
    ...
    // Use Electric user if available, otherwise use auth context
    const currentUser = electricUser
        ? {
              name: electricUser.name,
              email: electricUser.email,
              image: electricUser.avatar,
