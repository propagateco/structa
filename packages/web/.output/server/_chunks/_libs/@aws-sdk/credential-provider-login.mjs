...
import { r as readFile, p as parseKnownFiles, g as getProfileName } from "../@smithy/shared-ini-file-loader.mjs";
...
class LoginCredentialsFetcher {
  ...
  async refresh(token) {
    const { SigninClient, CreateOAuth2TokenCommand } = await import("./nested-clients.mjs").then(function(n) {
      return n.b;
    });
