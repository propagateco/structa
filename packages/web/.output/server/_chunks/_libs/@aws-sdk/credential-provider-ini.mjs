import { C as CredentialsProviderError, c as chain } from "../@smithy/property-provider.mjs";
import { f as setCredentialFeature } from "./core.mjs";
import { g as getProfileName, p as parseKnownFiles } from "../@smithy/shared-ini-file-loader.mjs";
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData2) => {
  ...
  if (!options.roleAssumer) {
    const { getDefaultRoleAssumer } = await import("./nested-clients.mjs").then(function(n) {
      return n.a;
    });
