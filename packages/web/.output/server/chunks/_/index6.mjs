...
import { P as ProviderError, I as IniSectionType, x as CONFIG_PREFIX_SEPARATOR, u as readFile, y as getConfigFilepath, z as parseIni, k as getProfileName, C as CredentialsProviderError } from "./server-DkMexlIi.mjs";
import { promises } from "fs";
import { g as getSSOTokenFilepath, a as getSSOTokenFromFile } from "./getSSOTokenFromFile.mjs";
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger }) => {
  ...
  const { SSOClient, GetRoleCredentialsCommand } = await import("./loadSso.mjs");
