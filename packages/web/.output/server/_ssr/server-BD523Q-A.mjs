...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CadbvCDx.mjs");
...
const manifest = { "58b28b0f92992cf730bdfa37e3cb305b95f9fae3fdeee3d5258691d9a8c8d457": {
  ...
  importer: () => import("./auth-server-BOFJUg1A.mjs")
...
async function loadEntries() {
  const routerEntry = await import("./router-DNVJLcrz.mjs").then((n) => n.r);
...
const serverBD523QA = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  HEADERS,
  StartServer,
  attachRouterServerSsrUtils,
