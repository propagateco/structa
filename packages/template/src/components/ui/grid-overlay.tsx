const GridOverlay = () => {
    ...
    const gridLines = [
        ...
        { gridColumn: "7 / 7" }, // Column 7 (center)
        { gridColumn: "9 / 9" }, // Column 9
        { gridColumn: "11 / 11" }, // Column 11
        { gridColumn: "13 / 13" }, // Column 13 (right edge)
    ];
    ...
    return (
        ...
        >
            ...
            <div className="h-full w-full max-w-[1100px] mx-auto relative">
                <div className="grid grid-cols-4 sm:grid-cols-6 lg:grid-cols-12 h-full gap-0">
