          ...
          <div className="mx-auto max-w-[1400px] px-8 pt-8 pb-24 md:pt-12 md:pb-32 relative z-10">
            <div className="grid grid-cols-4 sm:grid-cols-8 lg:grid-cols-16 gap-0">
              ...
              <p className="mx-auto max-w-2xl text-center text-lg text-muted-foreground font-light leading-relaxed">
                Acme builds your dream MVP in 14 days (stress-free). Then, we'll build systems to get your <b>first paying customers</b>.
              </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 pt-6">
                        ...
                        <div className="space-y-2">
                          <h3 className="text-4xl font-medium text-[#f97316]">500K+</h3>
                        ...
                        {/* Stat 2 */}
                        <div className="space-y-2">
                          <h3 className="text-4xl font-medium text-[#f97316]">4M+</h3>
                        ...
                        {/* Stat 4 */}
                        <div className="space-y-2">
                          <h3 className="text-4xl font-medium text-[#f97316]">100%</h3>
                ...
                <div className="grid grid-cols-4 sm:grid-cols-8 lg:grid-cols-16 gap-0">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        <h3 className="text-2xl font-medium">Modern, hyper-reliable stack</h3>
                        <p className="text-muted-foreground">
                          Acme builds insanely fast with the help of software powerhouses. No bugs, no fluff.
                        </p>
                        <div className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer group" onClick={() => window.open('https://calendly.com/harrison-from-acme/30min', '_blank')}>
                          <span className="text-sm font-medium">Let's talk ideas</span>
                          <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        <h3 className="text-2xl font-medium">Start to finish, code-to-customer.</h3>
                        <p className="text-muted-foreground">
                          We don't hand you the code & disappear. We code it, deploy it, & sell it. We source the leads, build the systems, everything.
                        </p>
                        <div className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer group" onClick={() => window.open('https://calendly.com/harrison-from-acme/30min', '_blank')}>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        <h3 className="text-2xl font-medium">Done-for-you marketing systems.</h3>
                        <p className="text-muted-foreground">
                          Not just outbound. We'll build organic content funnels within popular communities to get your first customers, too.
                        </p>
                        <div className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer group" onClick={() => window.open('https://calendly.com/harrison-from-acme/30min', '_blank')}>
                          <span className="text-sm font-medium">Build your MVP</span>
                          <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                        </div>
                      </div>
                    </div>
  ...
  <div className="flex gap-8 animate-scroll">
    ...
    <div className="flex gap-8 min-w-full">
      <div className="w-[400px] space-y-3">
        ...
        />
        <p className="text-sm text-muted-foreground text-center">AI Social monitoring for agencies & brands</p>
      ...
      <div className="w-[400px] space-y-3">
        <img 
          ...
          className="h-8 w-auto mx-auto"
        />
        <p className="text-sm text-muted-foreground text-center">B2B Data platform for startups</p>
        <div className="rounded-lg overflow-hidden">
          <video 
            autoPlay 
            loop 
      ...
      <div className="w-[400px] space-y-3">
        <img 
          ...
          className="h-8 w-auto mx-auto"
        />
        <p className="text-sm text-muted-foreground text-center">AI-powered videos for sales teams</p>
        <div className="rounded-lg overflow-hidden">
          <video 
            autoPlay 
            loop 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-white p-8">
                      <div className="space-y-4">
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed">
                          We'll monitor subreddits and find customers discussing problems your product solves.
                        </p>
                        <div className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer" onClick={() => window.open('https://calendly.com/harrison-from-acme/30min', '_blank')}>
                          <span className="text-sm">Find Reddit customers</span>
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-white p-8">
                      <div className="space-y-4">
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed">
                          We'll track conversations and engage with potential customers in real-time.
                        </p>
                        <div className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer" onClick={() => window.open('https://calendly.com/harrison-from-acme/30min', '_blank')}>
                          <span className="text-sm">Build your MVP</span>
                          <ArrowUpRight className="ml-2 h-4 w-4" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-white p-8">
                      <div className="space-y-4">
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed">
                          We'll find relevant video content and comments where your audience hangs out.
                        </p>
                        <div className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer" onClick={() => window.open('https://calendly.com/harrison-from-acme/30min', '_blank')}>
                          <span className="text-sm">Build a YouTube funnel</span>
                          <ArrowUpRight className="ml-2 h-4 w-4" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-white p-8">
                      <div className="space-y-4">
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed">
                          We'll connect with indie founders and discover opportunities in the maker community.
                        </p>
                        <div className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer" onClick={() => window.open('https://calendly.com/harrison-from-acme/30min', '_blank')}>
                          <span className="text-sm">Blow up on IndieHackers</span>
                          <ArrowUpRight className="ml-2 h-4 w-4" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-white p-8">
                      <div className="space-y-4">
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed">
                          We'll find and answer questions related to your product to build authority.
                        </p>
                        <div className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer" onClick={() => window.open('https://calendly.com/harrison-from-acme/30min', '_blank')}>
                          <span className="text-sm">Get Quora customers</span>
                          <ArrowUpRight className="ml-2 h-4 w-4" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-white p-8">
                      <div className="space-y-4">
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed">
                          We'll track reviews and ratings of your product and competitors on G2.
                        </p>
                        <div className="flex items-center text-gray-600 hover:text-gray-900 cursor-pointer" onClick={() => window.open('https://calendly.com/harrison-from-acme/30min', '_blank')}>
                          <span className="text-sm">Find product gaps on G2</span>
                          <ArrowUpRight className="ml-2 h-4 w-4" />
                        </div>
                      </div>
                    </div>
              ...
              <section id="pricing" className="mx-auto max-w-[1400px] px-8">
                <div className="grid grid-cols-4 sm:grid-cols-8 lg:grid-cols-16 gap-0">
                  ...
                  <div className="space-y-4">
                    ...
                    <h2 className="text-4xl font-medium">Two simple plans to choose from</h2>
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mt-12">
                    ...
                    <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-background p-8">
                      <div className="space-y-6">
                        ...
                        <div>
                          <h3 className="text-2xl font-medium">MVP Build</h3>
                          <p className="text-muted-foreground mt-1">Everything you need to launch</p>
                        </div>

                        <div className="space-y-1">
                          <p className="text-5xl font-medium">$1,997</p>
                    ...
                    <div className="rounded-xl border-2 border-primary bg-background p-8 relative">
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          <h3 className="text-2xl font-medium">MVP & Acquisition System</h3>
                          <p className="text-muted-foreground mt-1">Complete solution with customer acquisition</p>
                        </div>

                        <div className="space-y-1">
                          <p className="text-5xl font-medium">$2,997</p>
                          <p className="text-muted-foreground">one-time</p>
                        </div>
