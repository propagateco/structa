...
export function BrandingOverviewCard({
  ...
  const debouncedUpdateName = useCallback((value: string) => {
  ...
  const debouncedUpdateDescription = useCallback((value: string) => {
                    ...
                    <FormControl>
                      <Input
                        ...
                        onChange={(e) => {
                          ...
                          if (!errors && value.length >= 1 && value.length <= 30) {
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        onChange={(e) => {
                          ...
                          // Validate synchronously using form state
                          const value = e.target.value;
                          const errors = form.getFieldState("description").error;
