...
import { brandingChangesAtom, getBrandingFontFamilyAtom } from "@/state/branding";
        ...
        >
          ...
          <div className="relative flex flex-col h-full overflow-hidden justify-between">
            <div className="flex flex-col w-full gap-5 px-3">
              ...
              <WorkoutPreview branding={preview} getFontFamily={getFontFamily} />
              <ExampleProgramCard branding={preview} getFontFamily={getFontFamily} />
            </div>
            <TabBar
              branding={preview}
