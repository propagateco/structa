...
describe('Loops Integration', () => {
    ...
    describe('createContactInLoops', () => {
        ...
        it('should handle API errors', async () => {
            ...
            mockUpdateContact.mockRejectedValueOnce(
                new APIError(400, { success: false, message: 'The email address is not valid' } as any)
            );
        ...
        it('should handle rate limit errors', async () => {
            ...
            mockUpdateContact.mockRejectedValueOnce(new RateLimitExceededError(10, 0));
        ...
        it('should handle network errors', async () => {
            mockUpdateContact.mockRejectedValueOnce(new Error('Network error: Failed to connect'));
    ...
    describe('sendEventInLoops', () => {
        ...
        it('should handle event API failures', async () => {
            ...
            mockSendEvent.mockRejectedValueOnce(
                new APIError(404, { success: false, message: 'The specified event does not exist' } as any)
            );
    ...
    describe('testLoopsApiKey', () => {
        ...
        it('should handle invalid API key', async () => {
            const { APIError } = await import('loops');
            mockTestApiKey.mockRejectedValueOnce(new APIError(401, { error: 'Invalid API key' } as any));
