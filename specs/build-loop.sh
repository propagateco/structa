...
log_info "Starting Ralph - Max iterations: $MAX_ITERATIONS"
...
for i in $(seq 1 $MAX_ITERATIONS); do
  echo ""
  echo "${BOLD}═══════════════════════════════════════════════════════${RESET}"
  echo "  ${BOLD}Ralph Iteration $i of $MAX_ITERATIONS${RESET}"
  echo "${BOLD}═══════════════════════════════════════════════════════${RESET}"
  ...
  opencode run --agent ralph "Start iteration $i" > "$tmpfile" 2>&1 &
  ai_pid=$!
