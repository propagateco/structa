...
| Purpose | Document |
|---------|----------|
| **Architecture & Technical Decisions** | [architecture/overview.md](architecture/overview.md) |
...
| **Planning Specs** | [.plan/](../../.plan/) |
| **Mathematical & Physical Rules** | [../research/maths/coving_calculations.md](../research/maths/coving_calculations.md) |
...
│   │   ├── development_tools.md  # TypeScript, Biome, Vitest commands
│   │   └── worktrees.md       # Git worktrees & no-dev-server workflow
│   └── workflow/
│       ├── git_workflow.md    # PR workflow, quality gates, commits
│       └── deployment.md      # Deployment rules & restrictions
├── tools/
│   └── floorplan-ai/
│       └── spec.md            # Floor plan AI feature spec
├── strategy/
│   └── memo.md                # Product vision, GTM, market
├── research/
│   └── maths/
│       └── coving_calculations.md  # Crown molding compound angle formulas
└── landing/                   # Marketing (empty)
```
