...
### 3. `docs/core/development/worktrees.md`

Document the full model — isolation, `.sst` bug, bot-login auth, PR preview cycle.

### 4. Update `docs/core/workflow/git_workflow.md`
...
- [ ] **Worktree docs** — Write `docs/core/development/worktrees.md`
- [ ] **Git workflow docs** — Update `docs/core/workflow/git_workflow.md` (target `dev`, PR preview cycle)
- [ ] **Agent instructions** — Update `AGENTS.md` to codify the workflow
- [ ] **Dev tools cross-ref** — Add one-line pointer in `docs/core/development/development_tools.md`
...
- [ ] `docs/core/development/worktrees.md` documents the isolation model, `.sst` bug, bot-login auth, and PR preview cycle
